...
# Also Removes CensusTract as it is not a summable unit
...
Ccensus.pc=prcomp(scale(numericcensus.ct)) 
 ct.pc=Ccensus.pc$rotation[,c(1,2)]
numericcensus.subct=select(ungroup(census.subct), -County , -State,-CensusTract)
Sbcensus.pc=prcomp(scale(numericcensus.subct))
subct.pc=Sbcensus.pc$rotation[,c(1,2)]
```
...
census.tolower <- census.ct
census.tolower$State <- tolower(census.tolower$State)
census.tolower$County <- tolower(census.tolower$County)
tmpcensus <- census.tolower
